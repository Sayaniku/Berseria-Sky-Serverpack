events.listen('recipes', function (e) {
    ...
    //Cactus Neon//
    //Categorie
    e.custom({ "type": "botanypots:soil", "input": { "item": "betterendforge:endstone_dust" }, "display": { "block": "betterendforge:endstone_dust" }, "categories": ["endstone_dust"], "growthModifier": 0 })
    //BotanyPot
    e.custom({
        "type": "botanypots:crop",
        "seed": {
        ...
        "growthTicks": 2400,
        "display": {
            "block": "betterendforge:neon_cactus"
        },
        "results": [
            {
                "chance": 0.5,
    ...
    e.custom({
        ...
        "growthTicks": 2400,
        "display": {
            "block": "betterendforge:end_lotus_seed"
        },
        "results": [
            {
                "chance": 0.5,
