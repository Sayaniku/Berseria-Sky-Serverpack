onEvent('recipes', (e) => {
    const id_prefix = 'berseria_sky:minecraft/blasting/';
    const recipes = [
           {
           ...
           {
            input: { ingredient: { item: 'berseria_sky:manyerium_dust' }},
            output:   'berseria_sky:manyerium_ingot',
            experience: 0.5, 
            cookingtime: 300,
            id: `${id_prefix}from_manyerium_dust`
           },
           {
            input: { ingredient: { item: 'berseria_sky:fayronium_dust' }},
            output:   'berseria_sky:fayronium_ingot',
            experience: 0.6, 
            cookingtime: 400,
            id: `${id_prefix}from_fayronium_dust`
           },
           {
            input: { ingredient: { item: 'berseria_sky:queens_steel_dust' }},
            output:   'berseria_sky:queens_steel_ingot',
            experience: 0.4, 
            cookingtime: 200,
            id: `${id_prefix}from_queens_steel_dust`
           },
           {
            input: { ingredient: { item: 'berseria_sky:manronium_steel_dust' }},
            output:   'berseria_sky:manronium_steel_ingot',
            experience: 0.8, 
            cookingtime: 200,
            id: `${id_prefix}from_manronium_steel_dust`
           },
           {
            input: { ingredient: { item: 'tinkers_reforged:duralumin_dust' }},
            output:   'tinkers_reforged:duralumin_ingot',
            experience: 0.2, 
            cookingtime: 200,
            id: `${id_prefix}from_duralumin_dust`
           },
           {
            input: { ingredient: { item: 'tinkers_reforged:gausum_dust' }},
            output:   'tinkers_reforged:gausum_ingot',
            experience: 0.2, 
            cookingtime: 200,
            id: `${id_prefix}from_gausum_dust`
           },
           {
            input: { ingredient: { item: 'tinkers_reforged:electrical_copper_dust' }},
            output:   'tinkers_reforged:electrical_copper_ingot',
            experience: 0.2, 
            cookingtime: 200,
            id: `${id_prefix}from_electrical_copper_dust`
           },
           {
            input: { ingredient: { item: 'tinkers_reforged:blazing_copper_dust' }},
            output:   'tinkers_reforged:blazing_copper_ingot',
            experience: 0.2, 
            cookingtime: 200,
            id: `${id_prefix}from_blazing_copper_dust`
           ...
           {
            input: { ingredient: { item: 'tinkers_reforged:lavium_dust' }},
            output:   'tinkers_reforged:lavium_ingot',
            experience: 0.2, 
            cookingtime: 200,
            id: `${id_prefix}from_lavium_dust`
           },
           {
            input: { ingredient: { item: 'tinkers_reforged:qivium_dust' }},
            output:   'tinkers_reforged:qivium_ingot',
            experience: 0.2, 
            cookingtime: 200,
            id: `${id_prefix}from_qivium_dust`
           },
           {
            input: { ingredient: { item: 'extendedcrafting:crystaltine_dust' }},
            output:   'extendedcrafting:crystaltine_ingot',
            experience: 1, 
            cookingtime: 400,
            id: `${id_prefix}from_crystaltine_dust`
           },           
