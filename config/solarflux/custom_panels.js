...
function init() {
    ...
    panel()
        ...
        .buildAndRegister()
        .langBuilder()
        .put("en_us", "Fayronium Solar Panel")
        .build()
    ...
    panel()
        ...
        .buildAndRegister()
        .langBuilder()
        .put("en_us", "Queen's Steel Solar Panel")
        .build()
    ...
    panel()
        ...
        .height(6 / 16.0)
        .generation("4200000")
        .capacity("16500000000")
        .transfer("32800000")
        .buildAndRegister()
        .langBuilder()
        .put("en_us", "Manyerium Solar Panel")
        .build()

    panel()
        .name("manronium_steel")
        .height(6 / 16.0)
        .generation("8500000")
        .capacity("32800000000")
        .transfer("65600000")
        .buildAndRegister()
        .langBuilder()
        .put("en_us", "Manronium Steel Solar Panel")
        .build()
